...
yum -y install rsync sed ed tcl.ppc tcl.ppc64 tcl-devel.ppc tcl-devel.ppc64 tk.ppc tk.ppc64 tk-devel.ppc tk-devel.ppc64 wget expat.ppc expat.ppc64 expat-devel.ppc expat-devel.ppc64 glibc.ppc glibc-devel.ppc glibc.ppc64 glibc-devel.ppc64 glibc-headers glibc-static.ppc glibc-static.ppc64 libstdc++.ppc libstdc++-devel.ppc libstdc++.ppc64 libstdc++-devel.ppc64 elfspe2 netpbm.ppc netpbm-devel.ppc netpbm.ppc64 netpbm-devel.ppc64 numactl.ppc numactl-devel.ppc numactl.ppc64 numactl-devel.ppc64 libspe2.ppc libspe2.ppc64 libspe2-adabinding-devel libspe2-devel.ppc libspe2-devel.ppc64 libspe2-manpages cellperfctr-driver ppu-gcc-fortran ppu-gcc-gnat spu-gcc-fortran cell-spu-timing cellperfctr-tools blas.ppc64 blas-devel.ppc64 cell-xlc-ssc-cmp cell-xlc-ssc-help cell-xlc-ssc-lib cell-xlc-ssc-man cell-xlc-ssc-omp cell-xlc-ssc-rte cell-xlc-ssc-rte-lnk
